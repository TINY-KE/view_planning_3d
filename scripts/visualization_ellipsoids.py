...
class EllipsoidVisualizer:
    def __init__(self):
        ...
        # 视觉计算机大修
        self.ellipsoids = [
            {"name": "黄桌子", "x": 1.5, "y": 1.95, "z": 0.43, "roll": 0, "pitch": 0, "yaw": 0, "a": 1.4, "b": 1, "c": 1.3, "color": [1.0, 1.0, 0.0, 0.8]},  # 黄色
            {"name": "电视桌", "x": 4.0, "y": 2.1, "z": 0.75, "roll": 0, "pitch": 0, "yaw": 0, "a": 1.5, "b": 0.6, "c": 1, "color": [128/255.0, 0/255.0, 128/255.0, 0.8]},   # 紫色
            {"name": "圆桌子", "x": 5.55, "y": 1.430089, "z": 0.58, "roll": 0, "pitch": 0, "yaw": 0, "a": 1.2, "b": 1.6, "c": 1.2, "color": [0.0, 1.0, 0.0, 0.8]},  # 绿色
            {"name": "沙发", "x": 4.2, "y": -0.5, "z": 0.530371, "roll": 0, "pitch": 0, "yaw": 0, "a": 1.9, "b": 1.2, "c": 1.15, "color": [1.0, 0.0, 0.0, 0.8]},  # 红色
            {"name": "床", "x": -4.9, "y": -2.5, "z": 0.520094, "roll": 0, "pitch": 0, "yaw": 0, "a": 2.0, "b": 2.5, "c": 1.4, "color": [0.0, 0.0, 1.0, 0.8]},  # 蓝色
        ]
