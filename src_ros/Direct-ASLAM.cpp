...
int main(int argc, char **argv) {
    ...
    while (ros::ok()) {
        ...
        view_planning.planning_for_direct(target_object, robot_pose_x, robot_pose_y, arm_results, FootPrints, direct_yaws);  //计算FootPrints
        ...
        double yaw_divide = M_PI / FootPrints.size();
